...
## Version 0.5
- New: Software update system. The application now check if a new version of File Converter is available.
...
- New: Add an some help to explain how file converter works when you launch it without using the context menu.
- Fixed: Problem to convert images when accentuated characters was present in their path.
