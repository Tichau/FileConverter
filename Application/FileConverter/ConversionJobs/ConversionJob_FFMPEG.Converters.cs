...
namespace FileConverter.ConversionJobs
{
    ...
    public partial class ConversionJob_FFMPEG
    {
        ...
        private static string ComputeTransformArgs(ConversionPreset conversionPreset)
        {
            ...
            {
                // This presets use H265 codec, the size of the video need to be divisible by 2.
        ...
        /// </summary>
        /// <param name="quality">The quality index.</param>
        /// <returns>Returns the H265 constant rate factor.</returns>
        ...
        /// <summary>
        /// Convert video quality index to H265 constant rate factor.
        /// </summary>
        /// <param name="quality">The quality index.</param>
        /// <returns>Returns the H265 constant rate factor.</returns>
        ...
        private int H265QualityToCRF(int quality)
        {
            return 51 - quality;
        }
        ...
        /// <summary>
        /// Convert video encoding speed to H265 preset.
        /// </summary>
        /// <param name="encodingSpeed">The encoding speed.</param>
        /// <returns>The H265 preset.</returns>
        private string H265EncodingSpeedToPreset(VideoEncodingSpeed encodingSpeed)
        {
            ...
            throw new Exception("Unknown H265 encoding speed.");
        }
